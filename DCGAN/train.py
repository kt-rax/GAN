...
class Trainer:
    ...
    def load_MNIST(self,model_type = 3):
        ...
        if self.model_type not in allowed_types:
            print('ERROR: Only Integer Values -1 to 9 are allowed')
    ...
    def train(self):
        for e in range(self.EPOCHS):
            ...
            while len(X_train_temp) > self.BATCH:
                ...
                # Grab Real Images fro this training batch
                if self.flipCoin():
                    ...
                    # Delete the images used until we have noe left
                ...
                # In practice,flipping the label when training the generator improve convergence
                ...
                print('Epoch: '+str(int(e))+'   Batch: '+str(int(b))+',[Discriminator::Loss: '+str(discriminator_loss)+'],[Generator::Loss: '+str(generator_loss)+']')
    ...
    def sample_latent_space(self,instance):
        return np.random.normal(0,1,(instance,self.LATENT_SPACE_SIZE))
